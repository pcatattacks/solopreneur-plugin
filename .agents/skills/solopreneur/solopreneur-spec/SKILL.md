---
name: solopreneur-spec
description: Use when the user wants to turn an idea into a product requirements document or mentions `/solopreneur:spec`.
---

# solopreneur-spec

This is the Codex wrapper for the shared Solopreneur `spec` workflow.

## What to do

1. Read the repository root `AGENTS.md` for repo-wide Solopreneur guardrails.
2. Open `skills/spec/SKILL.md` and follow it as the source of truth.
...
5. Save outputs in `.solopreneur/specs/`.
