---
name: solopreneur-scaffold
description: Use when the user wants to design a custom AI org/plugin or mentions `/solopreneur:scaffold`.
---

# solopreneur-scaffold

This is the Codex wrapper for the shared Solopreneur `scaffold` workflow.

## What to do

1. Read the repository root `AGENTS.md` for repo-wide Solopreneur guardrails.
2. Open `skills/scaffold/SKILL.md` and follow it as the source of truth.
...
5. Save outputs in `the generated org/plugin directory plus supporting docs`.
