---
name: solopreneur-backlog
description: Use when the user wants to break a spec into tickets or mentions `/solopreneur:backlog`.
---

# solopreneur-backlog

This is the Codex wrapper for the shared Solopreneur `backlog` workflow.

## What to do

1. Read the repository root `AGENTS.md` for repo-wide Solopreneur guardrails.
2. Open `skills/backlog/SKILL.md` and follow it as the source of truth.
...
5. Save outputs in `.solopreneur/backlog/`.
