---
name: solopreneur-sprint
description: Use when the user wants to execute multiple backlog tickets in parallel or mentions `/solopreneur:sprint`.
---

# solopreneur-sprint

This is the Codex wrapper for the shared Solopreneur `sprint` workflow.

## What to do

1. Read the repository root `AGENTS.md` for repo-wide Solopreneur guardrails.
2. Open `skills/sprint/SKILL.md` and follow it as the source of truth.
...
5. Save outputs in `.solopreneur/backlog/ and related worktree artifacts`.
