...
- The output may include an `--- ARTIFACTS ---` section with actual file contents generated by the skill. Use these to verify claims about file creation, format compliance, and content quality. Artifacts are ground truth — prefer them over the skill's narration when they conflict.
