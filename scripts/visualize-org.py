...
<meta name="twitter:image" content="https://pcatattacks.github.io/solopreneur-plugin/og-image.png">"""
    ...
    if marketing:
        hero_html = f"""
  <div class="hero">
    <div class="pill reveal">Agent Plugin</div>
    ...
    <p class="install-prereq reveal">Then run <code>/plugins</code>, open the Solopreneur tab, and install the plugin. This branch pins the test ref until merge.</p>
    <p class="install-prereq reveal">Compatible with <a href="https://code.claude.com/docs/en/quickstart" target="_blank" rel="noopener">Claude Code</a> and <a href="https://developers.openai.com/codex/plugins/build" target="_blank" rel="noopener">Codex</a>. New to either? Check out the docs.</p>
